...
public class NormandyAmphibiousAssaultPositionUpdate 
{    
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        NormandyAmphibiousAssaultPositionUpdate jsonConverter = new NormandyAmphibiousAssaultPositionUpdate();
            ...
            while ((line = reader.readLine()) != null) 
            {
                ...
                if (line.startsWith(DevIOConstants.SHIP))
                {
                    ...
                    if (amphibiousAssault != null)
                    {
                        ...
                        if (landingCraftName.equals("lcm") || landingCraftName.equals("lct"))
                        {
                            amphibiousAssaultShipDefinition.setShipClass(AmphibiousAssaultShipClass.LANDING_CRAFT_TANK);
                        }
                        else if (landingCraftName.contains("destroyer"))
                        {
                            amphibiousAssaultShipDefinition.setShipClass(AmphibiousAssaultShipClass.DESTROYER);
                        }
                        else
                        {
                            amphibiousAssaultShipDefinition.setShipClass(AmphibiousAssaultShipClass.LANDING_CRAFT);
                        }
