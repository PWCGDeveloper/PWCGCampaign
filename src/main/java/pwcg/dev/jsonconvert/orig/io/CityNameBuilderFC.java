...
public class CityNameBuilderFC 
{    
    public static void main(String[] args) throws PWCGException
    {
        PWCGContext.setProduct(PWCGProduct.FC);

        CityNameBuilderFC jsonConverter = new CityNameBuilderFC();
        jsonConverter.getCityNames("WesternFront");
    }

    private void getCityNames (String mapName) throws PWCGException 
    {
        String filename = "D:\\PWCG\\WesternFrontData\\WesternFrontCities.Mission";     
