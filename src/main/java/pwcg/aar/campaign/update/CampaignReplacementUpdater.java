...
public class CampaignReplacementUpdater 
{
	private Campaign campaign;
	private AARContext aarContext;
	public CampaignReplacementUpdater(Campaign campaign, AARContext aarContext)
	{
		this.campaign = campaign;
        this.aarContext = aarContext;
	}
	
	public void updateCampaignReplacements () throws PWCGException
	{
		for (PersonnelReplacementsService replacementService : campaign.getPersonnelManager().getAllReplacements())
		{
