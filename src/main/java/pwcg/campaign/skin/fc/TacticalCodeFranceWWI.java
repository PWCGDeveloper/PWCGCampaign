...
public class TacticalCodeFranceWWI extends TacticalCode
{
    ...
    private void formWWICode(PlaneMcu plane, List<String> codes) throws PWCGException
    {
        ...
        {
            throw new PWCGException("Invalid code type: WWI France does not support position 1");
        }
        else if (plane.getSkin().getTacticalCodeType() == TacticalCodeType.CODE_POSITION_TWO)
        {
            throw new PWCGException("Invalid code type: WWI France does not support position 2");
        }
