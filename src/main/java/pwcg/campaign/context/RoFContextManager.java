...
import pwcg.campaign.ww1.plane.payload.RoFPayloadFactory;
import pwcg.core.exception.PWCGException;

public class RoFContextManager extends PWCGContextManagerBase implements IPWCGContextManager
{
    protected RoFContextManager()
    {
