...
public class GroundUnitBuilderAirfield
{
    ...
    {
        AirfieldUnitFactory groundUnitFactory = new AirfieldUnitFactory(campaign, targetDefinition.getTargetPosition(), targetDefinition.getTargetOrientation(), targetDefinition.getTargetCountry());
