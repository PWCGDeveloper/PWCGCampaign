...
public class SpitfireMkIXePayload extends PlanePayload implements IPlanePayload
{
	...
	{
        setAvailablePayload(-4, "10000001", PayloadElement.MERLIN_70_ENGINE);
        setAvailablePayload(-3, "1000001", PayloadElement.SPITFIRE_IX_WINGTIPS);
        setAvailablePayload(-2, "100001", PayloadElement.MIRROR);
        setAvailablePayload(-1, "10001", PayloadElement.GYRO_GUNSIGHT);
