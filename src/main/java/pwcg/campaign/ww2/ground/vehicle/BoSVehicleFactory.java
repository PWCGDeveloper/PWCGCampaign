...
import pwcg.campaign.ww2.ground.vehicle.Truck.TruckType;
...
public class BoSVehicleFactory implements IVehicleFactory
{
    ...
    {
        if (source instanceof ATArtillery)
        {
            ATArtillery sourceATArtillery = (ATArtillery)source;
            return sourceATArtillery.copy();
        }
