...
public class RoFStaticPlane extends Block implements IStaticPlane
{
	String staticPlaneName;
	
	public RoFStaticPlane (String staticPlaneName)
	{
    ...
    private void initialize ()
    {
        ...
        String script = "LuaScripts\\WorldObjects\\"  + staticPlaneName + ".txt";
