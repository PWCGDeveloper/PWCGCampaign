...
class Artillery extends Vehicle
{
    ...
    private static final List<VehicleDefinition> britishArtillery = new ArrayList<VehicleDefinition>() 
    {
        private static final long serialVersionUID = 1L;
        {
    ...
    public List<VehicleDefinition> getAllVehicleDefinitions()
    {
        ...
        allvehicleDefinitions.addAll(britishArtillery);
