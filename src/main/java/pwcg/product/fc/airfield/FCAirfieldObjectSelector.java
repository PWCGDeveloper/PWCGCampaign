...
import pwcg.product.fc.ground.staticobject.AirfieldObject;
import pwcg.core.exception.PWCGException;
import pwcg.core.location.Orientation;
import pwcg.core.utils.RandomNumberGenerator;
import pwcg.mission.ground.vehicle.IVehicle;

public class FCAirfieldObjectSelector implements IAirfieldObjectSelector
{
	private Date date;
	
    public FCAirfieldObjectSelector(Date date)
	{
    	this.date = date;
	}
