...
public class RolandC2aPayload extends PlanePayload implements IPlanePayload
{
    public RolandC2aPayload(PlaneType planeType, Date date)
    {
    ...
    protected void initialize()
    {
        ...
        setAvailablePayload(-4, "10000", PayloadElement.GUAGE_SET);
    ...
    {
        RolandC2aPayload clone = new RolandC2aPayload(getPlaneType(), getDate());
