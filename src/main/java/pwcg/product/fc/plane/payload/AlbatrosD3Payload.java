...
public class AlbatrosD3Payload extends PlanePayload implements IPlanePayload
{
    public AlbatrosD3Payload(PlaneType planeType, Date date)
    {
    ...
    protected void initialize()
    {
        ...
        setAvailablePayload(-7, "100000000", PayloadElement.AMMO_COUNTER);
        ...
        setAvailablePayload(2, "11", PayloadElement.LEWIS_TOP);
    }

    @Override
    public IPlanePayload copy()
    {
        AlbatrosD3Payload clone = new AlbatrosD3Payload(getPlaneType(), getDate());
