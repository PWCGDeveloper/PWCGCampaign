...
public class SpitfireMkIXcPayload extends PlanePayload implements IPlanePayload
{
    ...
    public SpitfireMkIXcPayload(PlaneType planeType, Date date)
    {
	...
	{
        setAvailablePayload(-5, "1000000000", PayloadElement.OCTANE_150_FUEL);
        setAvailablePayload(-4, "100000000", PayloadElement.MERLIN_70_ENGINE);
    ...
    {
    	SpitfireMkIXcPayload clone = new SpitfireMkIXcPayload(getPlaneType(), getDate());
