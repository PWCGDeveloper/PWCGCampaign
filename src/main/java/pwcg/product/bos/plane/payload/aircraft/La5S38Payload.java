...
public class La5S38Payload extends PlanePayload implements IPlanePayload
{
    private Date m82FIntroDate;

    public La5S38Payload(PlaneType planeType, Date date)
    {
	...
	{
        setAvailablePayload(-3, "100000", PayloadElement.MIRROR);
        setAvailablePayload(-2, "10000", PayloadElement.RPK10);
        setAvailablePayload(-1, "1000", PayloadElement.LANDING_LIGHTS);
    ...
    {
        La5S38Payload clone = new La5S38Payload(getPlaneType(), getDate());
