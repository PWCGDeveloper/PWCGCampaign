...
public class CampaignPilotLogPanelSet extends ImageResizingPanel implements ActionListener
{
    ...
    public CampaignPilotLogPanelSet(Campaign campaign, SquadronMember pilot)
    {
        super("");
