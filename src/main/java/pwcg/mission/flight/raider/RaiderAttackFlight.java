...
public class RaiderAttackFlight extends Flight implements IFlight
{
    public RaiderAttackFlight(FlightInformation flightInformation, TargetDefinition targetDefinition)
    {
    ...
    private void createWaypoints() throws PWCGException
    {
        ...
        RaiderAttackWaypointFactory missionWaypointFactory = new RaiderAttackWaypointFactory(this);
