...
{       
    ...
    public CrossWaypointPattern(Campaign campaign, Flight flight, WaypointType waypointType, WaypointAction waypointAction, int wpTriggerArea) throws PWCGException 
    {
