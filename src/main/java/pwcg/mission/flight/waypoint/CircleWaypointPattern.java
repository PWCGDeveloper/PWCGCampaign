...
{	 	
	...
	public CircleWaypointPattern(Campaign campaign, Flight flight, WaypointType wpType, WaypointAction wpAction, int wpTriggerArea, int legsInCircle) throws PWCGException 
	{
