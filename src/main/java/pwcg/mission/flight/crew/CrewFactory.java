...
public class CrewFactory
{
    ...
    {
        Map<Integer, SquadronMember> pilots = campaign.getPersonnelManager().getSquadronPersonnel(squadron.getSquadronId()).getActiveSquadronMembersWithAces().getSquadronMembers();        
