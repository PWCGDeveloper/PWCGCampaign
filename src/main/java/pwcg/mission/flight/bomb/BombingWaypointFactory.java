...
public class BombingWaypointFactory
{
    ...
    {
        IAirGroundAttackAreaMcuSequence attackMcuSequence = AirGroundAttackMcuSequenceFactory.buildAirGroundAttackSequence(flight, BOMB_ATTACK_TIME, BOMB_ATTACK_BINGO_TIME, AttackAreaType.INDIRECT);
