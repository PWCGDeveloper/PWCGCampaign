...
public class GroundFreeHuntFlight extends Flight implements IFlight
{
    public GroundFreeHuntFlight(FlightInformation flightInformation, TargetDefinition targetDefinition)
    {
    ...
    private void createWaypoints() throws PWCGException
    {
        ...
        GroundFreeHuntWaypointFactory missionWaypointFactory = new GroundFreeHuntWaypointFactory(this);
