...
{    
    ...
    {
        AirGroundAttackMcuSequence attackMcuSequence = AirGroundAttackMcuSequenceFactory.buildAirGroundAttackSequence(flight, PARA_DROP_TIME, PARA_DROP_BINGO_TIME, AttackAreaType.INDIRECT);
