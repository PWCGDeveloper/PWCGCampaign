 ...
 *
 */
public class Plane extends PlaneType implements Cloneable
{    
    ...
    public Plane(PlaneType planeType, ICountry country, SquadronMember pilot)
    {
        this.pilot = pilot;
    ...
    public void populateEntity(Flight flight, Plane flightLeader)
    {
    ...
    public void createPlaneRemover (Flight flight, Plane playerPlane) throws PWCGException 
    {
