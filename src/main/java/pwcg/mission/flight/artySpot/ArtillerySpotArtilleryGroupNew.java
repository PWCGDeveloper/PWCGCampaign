...
public class ArtillerySpotArtilleryGroupNew
{
	...
	public ArtillerySpotArtilleryGroupNew (IFlight artillerySpotFlight)
	{
	...
	public int getArtilleryEntryPoint() {
		return artilleryBattery.getEntryPoint();
	}
}
