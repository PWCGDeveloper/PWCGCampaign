...
public class ArtillerySpotFlight extends Flight implements IFlight
{
    public ArtillerySpotFlight(IFlightInformation flightInformation, TargetDefinition targetDefinition)
    {
