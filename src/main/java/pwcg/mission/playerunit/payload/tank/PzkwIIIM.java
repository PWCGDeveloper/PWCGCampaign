...
public class PzkwIIIM extends TankPayload implements ITankPayload
{
    public PzkwIIIM(TankType tankType, Date date)
    {
        super(tankType, date);
    }
    ...
    {
        PzkwIIIM clone = new PzkwIIIM(getTankType(), getDate());
