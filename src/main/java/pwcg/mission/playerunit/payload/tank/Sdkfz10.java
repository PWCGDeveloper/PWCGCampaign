...
public class Sdkfz10 extends TankPayload implements ITankPayload
{
    public Sdkfz10(TankType tankType, Date date)
    {
        super(tankType, date);
    }
    ...
    {
        Sdkfz10 clone = new Sdkfz10(getTankType(), getDate());
