...
public class T34Late extends TankPayload implements ITankPayload
{
    public T34Late(TankType tankType, Date date)
    {
        super(tankType, date);
    }
    ...
    {
        T34Late clone = new T34Late(getTankType(), getDate());
