...
import pwcg.mission.FCBugHandler;
import pwcg.mission.Mission;
import pwcg.mission.MissionAnalyzer;
...
public class MissionFinalizer
{
    ...
    private void cleanRunways() throws PWCGException
    {
        RunwayCleaner runwayCleaner = new RunwayCleaner(mission);
        runwayCleaner.cleanMissionRunways();
    }
    ...
    private void stopAttackingNearAirfield() throws PWCGException
    {
        ...
        {
            StopAttackingNearAirfield stopAttackingNearAirfield = new StopAttackingNearAirfield(flight, mission.getMissionAirfields());
