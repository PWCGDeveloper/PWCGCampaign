...
public class GroundAntiTankArtillery extends GroundDirectFireUnit
{
    ...
    {
        spawningVehicle = pwcg.mission.ground.vehicle.VehicleFactory.createVehicle(pwcgGroundUnitInformation.getCountry(), pwcgGroundUnitInformation.getDate(), VehicleClass.ArtilleryAntiTank);
