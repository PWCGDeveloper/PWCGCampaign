...
public class BoSAirfieldTest
{
	...
	public void pathTest() throws PWCGException
	{
	    ...
	    {
	        if (map.getMapIdentifier() == FrontMapIdentifier.BODENPLATTE_MAP || map.getMapIdentifier() == FrontMapIdentifier.EAST1945_MAP || map.getMapIdentifier() == FrontMapIdentifier.WESTERN_FRONT_MAP)
	        {
	            continue;
	        }
