...
public enum SquadronTestProfile
{
    ...
    JASTA_04_PROFILE("Jasta4", 401004, "19160901", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    JASTA_11_PROFILE("Jasta11", 401011, "19171001", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    JASTA_16_PROFILE("Jasta16", 401016, "19171001", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    ESC_103_PROFILE("Esc103", 301103, "19170801", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    ESC_2_PROFILE("Esc3", 301002, "19161101", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    ESC_3_PROFILE("Esc3", 301003, "19170801", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    RFC_2_PROFILE("RFC2", 302002, "19180331", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
    RFC_46_PROFILE("RFC46", 302046, "19170801", CampaignMode.CAMPAIGN_MODE_SINGLE, FrontMapIdentifier.WESTERN_FRONT_MAP, false),
