...
public enum SquadronTestProfile
{
    ...
    JV44_PROFILE("JV44", 20111044, "19450301", CampaignMode.CAMPAIGN_MODE_SINGLE),
    ...
    FG_365_BODENPLATTE_PROFILE("365th P47", 102365386, "19440906", CampaignMode.CAMPAIGN_MODE_SINGLE),
