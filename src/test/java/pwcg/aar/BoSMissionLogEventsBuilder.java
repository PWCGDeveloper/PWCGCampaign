...
public class BoSMissionLogEventsBuilder
{
    ...
    public BoSMissionLogEventsBuilder(Campaign campaign, AARPreliminaryData preliminaryData, AARTestExpectedResults expectedResults)
    {
