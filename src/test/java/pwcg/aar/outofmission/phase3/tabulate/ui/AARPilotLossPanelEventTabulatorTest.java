...
public class AARPilotLossPanelEventTabulatorTest extends AARTestSetup
{
    ...
    public void testMergedSquadronMembersLost() throws PWCGException 
    {
        ...
        SquadronMember squaddie2 = MissionEntityBuilder.makeSquadronMemberWithStatus("Squaddie B", SerialNumber.AI_STARTING_SERIAL_NUMBER+2, SquadronMemberStatus.STATUS_CAPTURED, campaign.getDate());
        SquadronMember squaddie3 = MissionEntityBuilder.makeSquadronMemberWithStatus("Squaddie C", SerialNumber.AI_STARTING_SERIAL_NUMBER+3, SquadronMemberStatus.STATUS_SERIOUSLY_WOUNDED, campaign.getDate());
        ...
        SquadronMember squaddie4 = MissionEntityBuilder.makeSquadronMemberWithStatus("Squaddie D", SerialNumber.AI_STARTING_SERIAL_NUMBER+4, SquadronMemberStatus.STATUS_KIA, campaign.getDate());
        SquadronMember squaddie5 = MissionEntityBuilder.makeSquadronMemberWithStatus("Squaddie E", SerialNumber.AI_STARTING_SERIAL_NUMBER+5, SquadronMemberStatus.STATUS_CAPTURED, campaign.getDate());
        SquadronMember squaddie6 = MissionEntityBuilder.makeSquadronMemberWithStatus("Squaddie F", SerialNumber.AI_STARTING_SERIAL_NUMBER+6, SquadronMemberStatus.STATUS_SERIOUSLY_WOUNDED, campaign.getDate());
