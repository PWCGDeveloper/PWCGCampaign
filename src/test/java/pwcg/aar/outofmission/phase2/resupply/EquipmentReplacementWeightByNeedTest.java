...
public class EquipmentReplacementWeightByNeedTest
{
    ...
    {
        Campaign earlyCampaign = CampaignCache.makeCampaignForceCreation(SquadronTestProfile.JG_51_PROFILE_MOSCOW);
    ...
    {
        Campaign lateCampaign = CampaignCache.makeCampaignForceCreation(SquadronTestProfile.JG_51_PROFILE_WEST);        
