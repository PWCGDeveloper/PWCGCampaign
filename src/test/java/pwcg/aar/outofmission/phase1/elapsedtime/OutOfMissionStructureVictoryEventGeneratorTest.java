...
public class OutOfMissionStructureVictoryEventGeneratorTest
{
    ...
    public void testPilotOutOfMissionVictory(AiSkillLevel aiSkillLevel) throws PWCGException
    {
        ...
        {
            OutOfMissionStructureVictoryEventGenerator victoryGenerator = new OutOfMissionStructureVictoryEventGenerator(campaign, squadronMember);
        ...
        assert(victory.getVictim().getPilotSerialNumber() == SerialNumber.NO_SERIAL_NUMBER);
    }
