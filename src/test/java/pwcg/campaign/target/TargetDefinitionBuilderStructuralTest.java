...
public class TargetDefinitionBuilderStructuralTest
{
    ...
    public void setupSuite() throws PWCGException
    {
        ...
        campaign = TestCampaignFactoryBuilder.makeCampaign(this.getClass().getCanonicalName(), SquadronTestProfile.STG77_PROFILE);
    ...
    {
        TargetDefinitionBuilderStructural targetSelector = new TargetDefinitionBuilderStructural(mission.getFlights().getPlayerFlights().get(0).getFlightInformation());
