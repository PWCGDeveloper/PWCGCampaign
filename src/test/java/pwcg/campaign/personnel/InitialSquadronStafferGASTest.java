...
public class InitialSquadronStafferGASTest
{
    ...
    public void generatePersonnelWithAcesTest() throws PWCGException
    {
        ...
        Company squadron = PWCGContext.getInstance().getSquadronManager().getSquadron(SquadronTestProfile.JASTA_11_PROFILE.getSquadronId());
        ...
        assert(filteredCrewMembers.getCrewMemberList().size() == Company.SQUADRON_STAFF_SIZE);
    }
